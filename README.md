...
- `src/transports`: common adapter contract, direct mock/Internet links, a custody-safe fragmented small-MTU adapter, and a physical raw-frame boundary with Meshtastic policy.
